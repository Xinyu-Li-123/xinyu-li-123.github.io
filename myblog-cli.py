...
def main():
    ...
    new_parser = subparsers.add_parser(
        "new",
        help='Create a new blog post. For example, to create a post under misc folder, we can do `./myblog-cli.py --dest-folder content/posts/misc --title "xxx"`',
    )
    new_parser.add_argument(
        "--dest-folder", required=True, help="Destination folder for the blog post"
    )
    new_parser.add_argument("--title", required=True, help="Title of the blog post")
